...
// The player's shots, `columns` to a line, split into THIS SESSION and EARLIER around `since` (a session's started_at; "" for one run).
Item {
    id: grid
    ...
    readonly property real sectionHeight: Theme.dp(52)
    ...
    ListView {
        ...
        preferredHighlightBegin: grid.topPadding + grid.sectionHeight
        ...
        delegate: Item {
            ...
            width: list.width
            height: modelData.items.length === 0 ? Theme.dp(64) : grid.cellHeight
