...
pub struct Launch {
    ...
    pub hdr: Option<bool>,
    pub dlss_upgrade: Option<crate::config::Toggle>,
    ...
    pub gamescope_adaptive_sync: Option<crate::config::Toggle>,
...
pub fn set_dotted(doc: &mut toml_edit::DocumentMut, key: &str, value: &str) -> crate::Result<()> {
    ...
    let is_rate = key.starts_with("launch.")
        && crate::launch_keys::find(last).is_some_and(|k| matches!(k.kind, crate::launch_keys::Kind::Refresh | crate::launch_keys::Kind::Fps));
...
"#;
    ...
    fn set_dotted_edits() {
        ...
        assert_eq!(
            (g.launch.env["MANGOHUD"].as_str(), g.launch.env["DXVK_ASYNC"].as_str(), g.launch.dll_overrides["d3d11"].as_str()),
            ("1", "true", "n,b"),
